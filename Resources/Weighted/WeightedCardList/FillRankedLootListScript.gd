...
func _run():
	...
	var cards_1_4 : WeightedDataList = load("res://Resources/Weighted/WeightedCardList/Cost1Rank4CardList.tres")
	...
	var cards_2_4 : WeightedDataList = load("res://Resources/Weighted/WeightedCardList/Cost2Rank4CardList.tres")
	var cards_3_3 : WeightedDataList = load("res://Resources/Weighted/WeightedCardList/Cost3Rank3CardList.tres")
	...
	add_weight_to_list(new_rank_list, cards_1_1, 2)
	add_weight_to_list(new_rank_list, cards_1_2, 1)
	add_weight_to_list(new_rank_list, cards_2_1, 1)
	rank_2_list.starting_list = new_rank_list.duplicate()

	new_rank_list.clear()
	add_weight_to_list(new_rank_list, cards_1_2, 6)
	add_weight_to_list(new_rank_list, cards_1_3, 4)
	...
	new_rank_list.clear()
	add_weight_to_list(new_rank_list, cards_2_2, 6)
	...
	new_rank_list.clear()
	add_weight_to_list(new_rank_list, cards_2_3, 8)
	add_weight_to_list(new_rank_list, cards_2_4, 4)
	add_weight_to_list(new_rank_list, cards_1_4, 2)
	add_weight_to_list(new_rank_list, cards_3_3, 2)
	add_weight_to_list(new_rank_list, cards_1_3, 1)
	add_weight_to_list(new_rank_list, cards_2_2, 1)
	rank_5_list.starting_list = new_rank_list.duplicate()

	new_rank_list.clear()
	add_weight_to_list(new_rank_list, cards_2_4, 4)
	add_weight_to_list(new_rank_list, cards_2_3, 2)
	add_weight_to_list(new_rank_list, cards_3_3, 2)
